...
#' @param store_par_summary the summary table from the \code{PartInvMulti_we}
#' function under partial invariance.
#' 
#' @return SR: Success ratio, computed as \eqn{TP/(TP + FP)}.
#'         SE: Sensitivity, computed as \eqn{TP/(TP + FN)}.
#'         Sp: Specificity, computed as \eqn{TN/(TN + FP)}.
...
#' 
#' \code{ref_acc_indices_h} Takes in the outputs from the \code{PartInv_Multi_we} 
...
#'        invariance.
#' @return A 8 x 3 dataframe with columns 'strict invariance', 'partial 
#'        invariance', and 'h'.
