...
#' at different proportions of selection or at different threshold (cutoff)
#' values
#' 
...
#'   If no folder name is provided, saves plots in the current working
#'   directory.
#' @param suffix Optional string suffix appended to plot filenames. `""` by
#'   default.
#' @examples
#' \dontrun{
#' library(lavaan)
