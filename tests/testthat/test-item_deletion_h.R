...
CESD_pos_partinv <- PartInv(cut_z = 16/60 * 12,
                            ...
                            plot_contour = FALSE)
CESD_pos <- item_deletion_h(CESD_pos_partinv)
...
test_that("item_deletion_h() handles matrix input", {
  ...
  CESD_pos_mat <- item_deletion_h(CESD_pos_partinv_mat)
