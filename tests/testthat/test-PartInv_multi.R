result <- structure(list(`1` = list(lambda = structure(c(0.321851420828946, 
                                                       ...
                                                       .Dim = c(20L, 5L), .Dimnames = list(c("a2", "a5", "a7", "a9", "c3", "c4", "c8", 
                                                                                        "c9", "e1", "e4", "e6", "e7", "n1", "n2", "n6", "n8", "i2", "i8", 
                                                                                        "i9", "i10"), c("A", "C", "E", "N", "O")), 
                                                       class = c("lavaan.matrix", "matrix")), 
                                                       theta = structure(c(0.543886582321731, 0.172041746020309, 
                                                       ...
                                                       .Dim = c(20L, 20L), .Dimnames = list(c("a2", "a5", "a7", "a9", 
                                                                                                 "c3", "c4", "c8", "c9", "e1", "e4", "e6", "e7", "n1", "n2", "n6", 
                                                                                                 "n8", "i2", "i8", "i9", "i10"), c("a2", "a5", "a7", "a9", "c3", 
                                                                                                 "c4", "c8", "c9", "e1", "e4", "e6", "e7", "n1", "n2", "n6", "n8", 
                                                                                                 "i2", "i8", "i9", "i10")), 
                                                       class = c("lavaan.matrix.symmetric", "matrix")), 
                                                       psi = structure(c(1, 0.0307300527642325, 0.397826036072362, 
                                                       ...
                                                       .Dim = c(5L, 5L), .Dimnames = list(c("A", "C", "E", "N", "O"), c("A", "C", "E", "N", "O")),
                                                       class = c("lavaan.matrix.symmetric","matrix")), 
                                                       nu = structure(c(3.94424798096106, 3.56191664603162, 
                                                      ...
                                                      .Dim = c(5L, 1L), .Dimnames = list(c("A", "C", "E", "N", "O"), "intercept"), 
                                                      class = c("lavaan.matrix", "matrix"))), 
                                                      `2` = list(lambda = structure(c(0.321851420828946, 0.65505328221763, 
                                                         ...
                                                         0.425281197599131, 0.484803397473042, 0.569706848613303), 
                                                       .Dim = c(20L, 5L), .Dimnames = list(c("a2", "a5", "a7", "a9", "c3", "c4", 
                                                                                        "c8", "c9", "e1", "e4", "e6", "e7", "n1", "n2", "n6", "n8", 
                                                                                        "i2", "i8", "i9", "i10"), c("A", "C", "E", "N", "O")), 
                                                       class = c("lavaan.matrix", "matrix")), 
                                                       theta = structure(c(0.543886582321732, 0.0991628559089238, 
                                                       ...
                                                       .Dimnames = list(c("a2", "a5", "a7", "a9", "c3", "c4", "c8", "c9", "e1", 
                                                           ...
                                                           "i9", "i10"), c("a2", "a5", "a7", "a9", "c3", "c4", "c8", 
                                                                           "c9", "e1", "e4", "e6", "e7", "n1", "n2", "n6", "n8", 
                                                                           "i2", "i8", "i9", "i10")), class = c("lavaan.matrix.symmetric", "matrix")), 
                                                       psi = structure(c(0.561994064185727, -0.0358719479236162, 
                                                       ...
                                                       nu = structure(c(4.09824764469264, 3.56191664603162, 
                                                      ...
                                                      .Dim = c(20L, 1L), .Dimnames = list(c("a2", "a5", "a7", "a9", "c3", 
                                                                                            "c4", "c8", "c9", "e1", "e4", "e6", "e7", "n1", "n2", 
                                                                                            "n6", "n8", "i2", "i8", "i9", "i10"), "intercept"), 
                                                      class = c("lavaan.matrix", 
                                                                "matrix")), alpha = structure(c(0.742530416810915, 0.140276996932641, 
                                                                                                -0.0193402230099476, -0.0491017394271967, -0.458225607619261
                                                                ), .Dim = c(5L, 1L), .Dimnames = list(c("A", "C", "E", 
                                                                                                        "N", "O"), "intercept"), class = c("lavaan.matrix", "matrix"
...
test_that("PartInvMulti_we() runs with no latent weight input", {
  pimout_latwei_null <- PartInvMulti_we(propsel = .25,
                  weights_item = c(0.008125, 0.008125, 0.008125, 0.008125,
                                   0.044875, 0.044875, 0.044875, 0.044875,
                                   0.117325, 0.117325, 0.117325, 0.117325,
                                   -0.048775, -0.048775, -0.048775, -0.048775,
