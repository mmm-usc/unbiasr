...
follow by a demonstration on the use of `PartInv` for multiple groups.
...
dat <- sjmisc::rec(rr, Age, append = T, suffix = "_gr",
...
partial_model <- '
  ...
  '
partial_fit <- cfa(partial_model, data = dat9, std.lv = TRUE, group = "Age_gr")

partinv9 <-
  PartInv(cut_z = 27.81,
          cfa_output = partial_fit,
