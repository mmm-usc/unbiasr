...
CESD_pos <- item_deletion_h(CESD_pos_partinv, delete_items = 1:4)
CESD_pos
```
...
We can obtain plots using `plot_contour = TRUE`. Additional optional parameters allow the plots to be customized with colors, group labels, and quadrant labeling (A, B, C, D or TR, FP, TN, FN).
