...
down to $h^{\rr}\PS^{|15}=0.021$, $h^{\rr}\SR=-0.151$ goes up to
$h^{\rr}\SR^{|15}=-0.045$, $h^{\rr}\SE=0.141$ goes down to
$h^{\rr}\SE^{|15}=0.026$ and $h^{\rr}\SP=-0.159$ goes up to
$h^{\rr}\SP^{|15}=-0.047$. Note that we judge improvement in the difference
