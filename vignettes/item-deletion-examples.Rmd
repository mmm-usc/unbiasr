...
- $h^{\rr}(\SAI^{|2})=\SE_{\rr}^{|2}$ for h comparing the SAI of r and Ef groups
for modified item set excluding the second item.
- $h^{\text{r-f}}(\SAI^{\str}) = \SE_{\text{r-f}}^{\str}$ for h comparing the SAI 
of r and f groups under SFI, for the full item set.
- $h^{\text{r-f}}(\SAI^{|2;\str}) = \SE_{\text{r-f}}^{|2; \str}$ for  h comparing
