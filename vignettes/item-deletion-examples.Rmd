...
```{r}
CESD_drop15 <- 
  item_deletion_h(cut_z = 16/60*(60-3),
...
```{r}
CESD_drop15$PartInv$`Full item set`
```

Subset excluding item 10:

```{r}
CESD_drop15$PartInv$`|10`
```
